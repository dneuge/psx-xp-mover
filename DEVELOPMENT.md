...
Releases should only be created and published by the mainline project on [Codeberg](https://codeberg.org/dneuge/psx-xp-mover) and [GitHub](https://github.com/dneuge/psx-xp-mover).
